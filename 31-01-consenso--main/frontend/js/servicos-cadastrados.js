            ...
            for (let index = 0; index < data.length; index++) {
                if (data[index].usuario.idUsuario == id) {
                    ...
                    <div class="row alert alert-success div-agendamento" id=${idServico}>
                        ...
                        <div class = "col-3" >
                        <a href="../pages/editar-servicos.html"><img class="a1-img divdiv"
                        src="../img/edit_square_FILL0_wght400_GRAD0_opsz48.png"></a>

                        <a href=""><img
                        class="a2-img" src="../img/delete_FILL0_wght400_GRAD0_opsz48.png" id = "${idServico}" onclick = "deletaItem(this.id)"></a>
                        </div>
